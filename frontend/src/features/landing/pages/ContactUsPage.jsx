        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-white border border-border-light rounded-2xl p-6 space-y-3">
              ...
              {email ? (
                <a href={`mailto:${email}`} className="text-sm font-semibold text-primary-dark hover:underline break-all">
                  {email}
                </a>
              ) : (
            ...
            <div className="bg-white border border-border-light rounded-2xl p-6 space-y-3">
              ...
              {phone ? (
                <a href={`tel:${phone}`} className="text-sm font-semibold text-primary-dark hover:underline">
                  {phone}
                </a>
              ) : (
                <p className="text-sm text-text-secondary">Not configured</p>
